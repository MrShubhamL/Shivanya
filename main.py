...
class Login(QWidget,zi):                # Login Code....
    ...
    def Handel_Login(self):
        ...
        MAC = str(physical_disc.SerialNumber)
            ...
            if username == row[0] and password == row[1]:
                ...
                for row in data2:
                    if MAC == row[0]:
                        ...
                        message2 = QMessageBox.information(self,"Expired!","You have not authoriesed User, Kindlly Contact the Customer Service")
                        # sys.exit(Login)
...
class MainApp(QMainWindow,Tk):
    def __init__(self):
        ...
        sql = ''' SELECT * FROM windowSetting'''
        self.cur.execute(sql)
        data = self.cur.fetchone()

        self.setGeometry(0, 0, (int(data[3])), (int(data[4])))
...
# ============== Main Menu Bar =======================
    ...
    def windowSetting(self):
        self.windowset = toolmenu.WindowSetting()
        self.mdi.addSubWindow(self.windowset)
        self.windowset.show()
        pass
